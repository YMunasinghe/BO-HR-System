              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6" align="right">
                    <a href="add_department.php"><h6 class="card-title"><button type="button" class="btn btn-outline-success">Add Department</button></h6></a>
                ...
                <div class="table-responsive">
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
											<?php
		                    $sql = 'SELECT * FROM  department JOIN company ON company.C_id=department.company';
