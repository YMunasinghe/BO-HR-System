    ...
    <!-- partial:partials/_sidebar.html -->
      ...
      <!-- partial -->
			...
			<div class="page-content">
				<?php include 'PHP/READ/departmentmangementscript.php';?>

				<nav class="page-breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
            <li class="breadcrumb-item"><i data-feather="chevron-right"></i><a href="Company-List.php"> Company List</a></li>
						<li class="breadcrumb-item active" aria-current="page"><i data-feather="chevron-right"></i> Update Department</a></li>
						...
						<div class="card-body">
							<h6 class="card-title">Update Department </h6>
								<form method="post" enctype="multipart/form-data" action="">
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="mb-3">
												...
												<input type="text" class="form-control" placeholder="Enter EPF No" name="Department_Name" value="<?php echo $Department_Name;?>">
											</div>
										</div><!-- Col -->
										...
										<div class="col-sm-3">
											<div class="mb-3">
												...
												$select_admin = "SELECT * FROM company WHERE C_id ='$company'";
												...
												?>
												<input type="text" class="form-control" placeholder="Enter Company Name" disabled   value="<?php echo $C_name;?>">
											</div>
										</div><!-- Col -->
										<div class="col-sm-3">
											<div class="mb-3">
													<label class="form-label">Update Company<code>*</code></label>
													<select class="form-select" id="exampleFormControlSelect1" name="company" required>
														<?php
									...
									<button type="submit" name="update_department" class="btn btn-primary submit">Update</button>
									</form>

									<?php include 'PHP/WRITE/updatedepartment.php';?>
						</div>
					</div>
				</div>
			</div>
