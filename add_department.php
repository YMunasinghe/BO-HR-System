					...
					<div class="col-md-12 stretch-card">
						<div class="card">
							<div class="card-body">
				                ...
				                <select class="js-example-basic-single form-select" data-width="100%" name="company">
				                  <?php
				                  ...
				                  <?php }?>
										...
										<div  id="dynamic-rows">
											...
											<div class="col-sm-10">
												<div class="mb-3">
													...
													<input type="text" class="form-control" placeholder="Department" name="COM_Department[]" required>
												</div>
											</div><!-- Col -->
									...
									<button id="submit-form-btn" type="submit" class="btn btn-success" name="add_comd">Add Department</button>
