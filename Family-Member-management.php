...
<body>
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i data-feather="chevron-right"></i>Assign Family Member </a></li>
	...
	<div class="row">
					<div class="col-md-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Assign Family Member</h4>
								...
								<div id="dynamic-rows">
  <div class="row">
    <h4 class="card-title">Member 01</h4>
    <div class="col-md-3 grid-margin stretch-card">
      <div class="mb-3">
        <label for="exampleInputUsername1" class="form-label">Name</label>
        <input type="text" class="form-control" autocomplete="off" placeholder="Name" name="FM_Name[]" required>
      </div>
    </div>
    <div class="col-md-3 grid-margin stretch-card">
      <div class="mb-3">
        <label for="exampleInputUsername1" class="form-label">Relationship</label>
        <input type="text" class="form-control" autocomplete="off" placeholder="Relationship" name="FM_Relationship[]" required>
      </div>
    </div>
    <div class="col-md-3 grid-margin stretch-card">
      <div class="mb-3">
        <label for="exampleInputUsername1" class="form-label">Age</label>
        <input type="text" class="form-control" autocomplete="off" placeholder="Age" name="FM_Age[]">
      </div>
    </div>
    <div class="col-md-3 grid-margin stretch-card">
      <div class="mb-3">
        <label for="exampleInputUsername1" class="form-label">Occupation</label>
        <input type="text" class="form-control" autocomplete="off" placeholder="Occupation" name="FM_Occupation[]">
      </div>
    </div>
    <div class="col-md-3 grid-margin stretch-card">
...
<button id="submit-form-btn" type="submit" class="btn btn-success" name="add_FamilyM">Add Family Members</button>

							</div>
						</form>
						</div>
					</div>
					<?php include 'PHP/WRITE/Family-Member-management-Script.php'; ?>
				</div>
			</div>
