...
<body>
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i data-feather="chevron-right"></i>Add Employment History </a></li>
				...
				<div class="row">
					<div class="col-md-12 stretch-card">
						<div class="card">
							<div class="card-body">
								<h4 class="card-title">Add Employment History </h4>
				                ...
				                <select class="js-example-basic-single form-select" data-width="100%" name="E_id" required>
				                  ...
				                  <?php }?>
										...
										<div  id="dynamic-rows">
											...
											<h4 class="card-title">Employment 01</h4>

											<div class="col-sm-3">
												<div class="mb-3">
													<label class="form-label">Position Held</label>
													<input type="text" class="form-control" placeholder="Position" name="EDU_Position[]" required>
												</div>
											</div><!-- Col -->
											<div class="col-sm-3">
												<div class="mb-3">
													<label class="form-label">Job Stated</label>
													<input type="date" class="form-control"  name="EMPH_JStated[]" required>
											...
											<div class="col-sm-3">
												<div class="mb-3">
													<label class="form-label">Job End</label>
													<input type="date" class="form-control"  name="EMPH_Jend[]" required>
											...
											<div class="col-sm-3">
												<div class="mb-3">
													...
													<input type="text" class="form-control" placeholder="Reason for Leaving" name="EMPH_Leaving[]">
												</div>
											</div><!-- Col -->
											...
											<div class="col-sm-10">
												<div class="mb-3">
													...
													<input type="text" class="form-control" placeholder="Company" name="EMPH_Company[]" required>
												</div>
											</div><!-- Col -->
									...
									<button id="submit-form-btn" type="submit" class="btn btn-success" name="add_emph">Add Employment</button>

									</form>
									<?php include_once 'PHP/WRITE/Employment-history-management-Script.php'; ?>
							</div>
						</div>
					</div>
				</div>
  ...
  $('#add-row-btn').click(function() {
    ...
    clonedRow.find('.card-title').text('Employment ' + lastMemberNumber);
