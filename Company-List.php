...
<body>
    ...
    <!-- partial:partials/_sidebar.html -->
      ...
      <!-- partial -->
            ...
            <li class="breadcrumb-item active" aria-current="page"><i data-feather="chevron-right"></i> Company List</a></li>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6" align="right">
                    <h6 class="card-title"><button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Company</button></h6>
                  ...
                  <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $row['C_EPFNo']; ?></td>
												<td>
													<a href="update-Company-List.php?view_company=<?php echo $row['C_id']; ?>"><button type="button" class="btn btn-primary">Edit</button>
												</td>
                      </tr>
											<?php $i++; } ?>
                    </tbody>
